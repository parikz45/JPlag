...
public abstract class Animal extends Organism
{
     ...
     */
    public Animal(boolean randomAge, Field field, Location location, int maxAge, int maxFoodValue, int breedingAge, double breedingProbability, int litterSize, double infectionProbability, Random rand)
    {
    ...
    protected int breed(Class c)
    {
        ...
        for(int i =0; i<animalLocations.size(); i++){
            ...
            if(organism instanceof Animal){
                 ...
                 */
                if(c.isInstance(animal) && animal.isMale() && !animal.hasBred() && animal.isAlive() && canBreed(breedingAge) && animal.canBreed(breedingAge) && rand.nextDouble() <= breedingProbability) {
                    //breed...
                    //System.out.println(this.getClass() + " age:" + getAge() + " male: "+ isMale() + " bred before: "+  hasBred() + " has bred with" + animal.getClass() + " age:" + animal.getAge() + " male: "+ animal.isMale() + " bred before: "+  animal.hasBred());
  ...
  //some weather conditions may affect the probability of the animal getting infected
