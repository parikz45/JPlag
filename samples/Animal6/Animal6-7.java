...
public abstract class Animal implements Actor
{
     ...
     * Changed: while loop remains but restructured using do-while style check
     * to emphasize the iterator pattern more explicitly.
     */
    private void spreadDisease()
    {
        if(rand.nextDouble() <= disease.getSpreadProbability()){
            ...
            // Changed: restructured from standard while to do-while
            // only if there are elements to process
     ...
     * Changed: for loop converted to while loop.
     */
     ...
     * nearby.
     * Changed: while loop restructured to do-while with an hasNext guard.
     */
