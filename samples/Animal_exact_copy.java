 ...
 */
public abstract class Animal_exact_copy extends Organism {
    Random rand;
     ...
     */
    public Animal_exact_copy(boolean randomAge, Field field, Location location, int maxAge, int maxFoodValue, int breedingAge,
    ...
    protected int breed(Class c) {
        ...
        for (int i = 0; i < animalLocations.size(); i++) {
            ...
            if (organism instanceof Animal_exact_copy) {
                Animal_exact_copy animal = (Animal_exact_copy) organism;
                /*
